...
var Localize = require("localize"),
    loc = new Localize({
        ...
        "EXCEPTION_INVALID_INVOKE_TARGETS_EMPTY": {
            "en": "rim:invokeTargets cannot be empty"
        },
        "EXCEPTION_INVALID_INVOKE_TARGET_NO_ATTRIBUTES": {
            "en": "invokeTarget does not have any attributes"
        },
        "EXCEPTION_INVOKE_TYPE_ATTRIB_INVALID": {
            "en": "The value of invokeType is not valid"
        },
        "EXCEPTION_INVOKE_ID_ATTRIB_INVALID": {
            "en": "The value of invokeId is not valid"
        }
