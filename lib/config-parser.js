...
function processInvokeTargetsData(data, widgetConfig) {
    if (data["rim:invokeTargets"] && data["rim:invokeTargets"]["invokeTarget"]) {
        ...
        if (invokeTarget instanceof Array) {
        ...
        //remove any empty permission elements
        invokeTargets.forEach(function (invokeTarget) {
...
function validateInvokeTargets(widgetConfig) {
    if (widgetConfig["rim:invokeTargets"]) {
        check(widgetConfig["rim:invokeTargets"]["invokeTarget"], localize("EXCEPTION_INVOKE_TARGETS_EMPTY"))
            .notNull()
            .notEmpty();
        
        invokeTargets.forEach(function (invokeTarget, index, widgetConfig["rim:invokeTargets"]) {
